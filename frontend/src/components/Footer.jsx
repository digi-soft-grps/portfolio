                ...
                <div className="footer-grid">
                    ...
                    <div className="footer-brand">
                        ...
                        <div className="social-links">
                            <a href="#" className="social-link glass"><Icons.Facebook size={18} /></a>
                            <a href="#" className="social-link glass"><Icons.Twitter size={18} /></a>
                            <a href="#" className="social-link glass"><Icons.Instagram size={18} /></a>
                            <a href="#" className="social-link glass"><Icons.Linkedin size={18} /></a>
                        </div>
                    </div>
